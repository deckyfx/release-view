 ...
 * @method     ChildEmailQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildEmailQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method     ChildEmailQuery groupById() Group by the id column
 * @method     ChildEmailQuery groupByEmail() Group by the email column
 * @method     ChildEmailQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildEmailQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method     ChildEmail findOneByCreatedAt(string $created_at) Return the first ChildEmail filtered by the created_at column
 * @method     ChildEmail findOneByUpdatedAt(string $updated_at) Return the first ChildEmail filtered by the updated_at column *
 ...
 * @method     ChildEmail requireOneByCreatedAt(string $created_at) Return the first ChildEmail filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildEmail requireOneByUpdatedAt(string $updated_at) Return the first ChildEmail filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildEmail[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildEmail objects filtered by the created_at column
 * @method     ChildEmail[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildEmail objects filtered by the updated_at column
...
abstract class EmailQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Models\Base\EmailQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Models\\Email', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email, created_at, updated_at FROM emails WHERE id = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(EmailTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(EmailTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EmailTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(EmailTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(EmailTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EmailTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(EmailTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(EmailTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(EmailTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(EmailTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(EmailTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(EmailTableMap::COL_CREATED_AT);
    }
